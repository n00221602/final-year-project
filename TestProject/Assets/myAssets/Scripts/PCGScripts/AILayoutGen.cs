...
public class AILayoutGen : MonoBehaviour
{
    ...
    {
      { 1,2,2,2,2,2,2,2,2,2,1},
      { 2,3,3,3,2,3,3,3,2,3,2},
      { 2,3,2,3,2,3,2,3,2,3,2},
      { 2,3,2,3,3,3,2,3,3,3,2},
      { 4,3,2,2,2,3,2,2,2,3,5},
      { 2,3,3,3,2,3,3,3,2,3,2},
    ...
    public int[,] layout3 = new int[,]
    {
      ...
      { 2,3,2,3,3,3,3,3,3,3,2,3,2},
      { 4,3,2,3,2,2,3,2,2,3,2,3,5},
      { 2,3,2,3,3,3,3,3,3,3,2,3,2},
      { 2,3,2,2,3,2,3,2,3,2,2,3,2},
      { 2,3,3,3,3,2,3,2,3,3,3,3,2},
      { 1,2,2,2,2,2,2,2,2,2,2,2,1}
